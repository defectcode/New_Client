      ...
      <div className="md:block hidden fixed right-0 w-[400px] bg-white z-50 top-[20px] bottom-[20px] shadow-lg overflow-hidden rounded-tl-[20px] rounded-bl-[20px]">
        <div className="flex flex-col justify-between h-full">
          <div>
            ...
            <div className="relative shadow-container py-5">
              <div className="absolute top-0 left-0 right-0 h-5 bg-gradient-to-b from-black/10 to-transparent z-10 pointer-events-none"></div>

              {/* Scrollable content limited to 4 items */}
              <div className="scroll-content-product overflow-y-auto max-h-[500px] px-5">
                {items.length ? (
                  items.map((item, index) => (
                    <CheckoutCartItem
                      item={item}
              ...
              <div className="absolute bottom-0 left-0 right-0 h-5 bg-gradient-to-t from-black/10 to-transparent z-10 pointer-events-none"></div>
            </div>
          </div>
