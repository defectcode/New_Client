    ...
    if (isMobile) {
        return (
            <div className="flex flex-col max-w-[470px] mx-auto bg-white rounded-lg shadow-md h-screen">
                ...
                <div className="overflow-y-auto flex-1 px-4 py-2 border-t border-[#E8E8ED]">
                    {items.map((item, index) => (
                        ...
                        >
                            <div className="w-[100px] h-[100px] bg-gray-100 flex-shrink-0 rounded-md">
                                <Image
                            ...
                            <div className="ml-4 flex flex-col justify-between w-full">
                                <div className="flex items-center justify-between">
                                    <h3 className="font-Heebo-15 text-[#1E1E1E] truncate-2-lines">
                                        {item.product.title}
                                    </h3>
                                    <button className="text-gray-400">♥</button>
                                </div>
                                <p className="text-sm text-[#8C8C8C] mt-1">{item.product.color?.name || 'Color'}</p>
                                <div className="flex items-center justify-between mt-2">
                                    <p className="text-[#5D5D5D] font-Heebo-14">${item.product.price.toFixed(2)}</p>
                                    <div className="flex items-center space-x-2">
                                        <button
                                            className="px-2 py-1 text-sm text-[#8C8C8C] border rounded disabled:opacity-50"
                                        ...
                                        <button
                                            className="px-2 py-1 text-sm text-[#8C8C8C] border rounded"
                ...
                <div className="p-4 border-t border-[#E8E8ED]">
                    ...
                    <div className="flex justify-between font-Heebo-16-semi mb-5">
                        <p>Total</p>
                    ...
                    <button className="w-full py-3 mb-3 text-white bg-black rounded-lg font-Heebo-16-semi h-[56px]">
