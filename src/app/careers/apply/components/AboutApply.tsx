...
interface AboutApplyProps {
  ...
  export default function AboutApply({ selectedPositions }: AboutApplyProps) {
    return (
      <section className="bg-neutral-900 text-white py-5 h-[328px]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <h2 className="text-[34px] mt-4 text-[#F7F7F7]/25 leading-[1]">
            {POSITION_DATA.subtitle}
          </h2>
          <h1 className="text-[56px] font-bold mt-2 leading-[1] text-[#F7F7F7] w-[950px]">
            {POSITION_DATA.title}
          </h1>
          <div className="relative">
            <div className="absolute top-0 right-0 bg-[#F7F7F7] shadow-lg rounded-[20px] w-[341px] h-[178px] p-5 flex flex-col justify-between text-[#1E1E1E]">
              <div className="flex justify-between gap-5 leading-[1]">
                <div className="flex flex-col space-y-[32px]">
                  <div className="text-[15px] space-y-5">
                    ...
                    <p className="font-medium">{POSITION_DATA.location}</p>
                  </div>
                  <div className="text-[15px] space-y-5">
                    <p className="text-[#949494]">Work Type</p>
                    <p className="font-medium">{POSITION_DATA.workType}</p>
                  </div>
                </div>
                <div className="flex flex-col space-y-[32px]">
                  <div className="text-[15px] space-y-5">
                    <p className="text-[#949494]">Team</p>
                    <p className="font-medium">{POSITION_DATA.team}</p>
                  </div>
                  <div className="text-[15px] space-y-5">
