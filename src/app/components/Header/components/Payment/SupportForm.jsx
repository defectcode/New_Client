...
const SupportForm = () => {
  ...
  const handlePaymentSuccess = async (paymentIntent) => {
    ...
    const email = paymentIntent.charges.data[0].billing_details.email; // Emailul utilizatorului
    const firstName = paymentIntent.charges.data[0].billing_details.name?.split(' ')[0]; // Prenumele utilizatorului
